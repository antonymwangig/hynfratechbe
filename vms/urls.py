...
from .views import VirtualMachineViewSet, CreateVMAPIView,StartVMAPIView
...
urlpatterns = [
    ...
    path('start-virtual-machine/<str:vm_name>/', StartVMAPIView.as_view(), name='virtual-machine'),
